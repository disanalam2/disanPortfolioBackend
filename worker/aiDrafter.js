...
async function findBusinessDetails(businessName, address) {
    ...
    try {
        ...
        CRITICAL TASKS:
        1. DEEP SEARCH: Use your search tool to check Facebook (site:facebook.com), Instagram (site:instagram.com), LinkedIn (site:linkedin.com), Threads, and JustDial/Yelp for this specific business. ALSO do a broad Google search for "[business name] [address] email OR contact OR 'contact us'" to find their official contact page or directory listings.
        ...
        3. EXTRACT MAXIMUM CONTACTS: Find EVERY public email address and EVERY phone number/WhatsApp associated with them across all platforms. DO NOT GUESS. You MUST try exceptionally hard to find an email address. Look for PDF brochures, about us pages, or local directories if you have to. Also extract their Instagram, Facebook, or LinkedIn URL if found.
